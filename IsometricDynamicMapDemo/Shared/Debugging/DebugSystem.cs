...
using IsometricDynamicMapDemo.Player;

namespace IsometricDynamicMapDemo.Shared.Debugging;
...
internal class DebugSystem : EntityDrawSystem
{
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        // When using a camera and render target to scale the screen, we need to adjust
        ...
        _spriteBatch.DrawString(
            spriteFont: _font,
            text: $"Mouse position in world: {worldPosition}",
